...
Public Class frmAddAdministrative
    ...
    Private sQLadminFath As String = "SELECT AdministrativeID,AdministrativeFather FROM tbAdministrative Where AdministrativeStatus=1 AND AdministrativeType='رئيسي'"
    ...
    Private Sub BGW_Load_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BGW_Load.DoWork
        Try
            If CheckConn() = False Then
                VarBGW_Status = False
            Else
                VarAdministrativeTypeDT = New DataTable()
                Call XCLS.MyCodes_Fill_DataTable(sQLadminFath, VarAdministrativeTypeDT)
    ...
    Private Sub BGW_Load_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BGW_Load.RunWorkerCompleted
        If VarBGW_Status = True Then
            ...
            If VarAdministrativeTypeDT.Rows.Count > 0 Then
                Call XCLS.MyCodes_CmbFill(Me.cmbAdministrativeFather, VarAdministrativeTypeDT, "AdministrativeFather", "AdministrativeID")
    ...
    Private Sub cmbAdministrativeType_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles cmbAdministrativeType.SelectionChangeCommitted
        ...
        Select Case Me.cmbAdministrativeType.SelectedItem
            Case "رئيسي"
                ...
                With Cmd
                    ...
                    .CommandText = "Insert Into tbAdministrative (AdministrativeType,AdministrativeFather,AdministrativeStatus,InsertTime,UserID_Insert)values(@AdministrativeType,@AdministrativeFather,@AdministrativeStatus,@InsertTime,@UserID_Insert)"
                    .Parameters.Clear()
                    .Parameters.AddWithValue("@AdministrativeType", SqlDbType.VarChar).Value = VarAdministrativeType
                    .Parameters.AddWithValue("@AdministrativeFather", SqlDbType.VarChar).Value = VarAdministrativeFather
            ...
            Case "فرعي"
                ...
                With Cmd
                    .Connection = sQlConnection
                    .CommandType = CommandType.Text
                    .CommandText = "Insert Into tbAdministrative (AdministrativeFather,AdministrativeParentCode,AdministrativeParent,AdministrativeParentLatin,AdministrativeStatus,InsertTime,UserID_Insert)values(@AdministrativeFather,@AdministrativeParentCode,@AdministrativeParent,@AdministrativeParentLatin,@AdministrativeStatus,@InsertTime,@UserID_Insert)"
                    .Parameters.Clear()
                    .Parameters.AddWithValue("@AdministrativeFather", SqlDbType.VarChar).Value = VarAdministrativeFather
                    ...
                    .Parameters.AddWithValue("@AdministrativeParentLatin", SqlDbType.VarChar).Value = VarAdministrativeParentLatin
                    .Parameters.AddWithValue("@AdministrativeStatus", SqlDbType.Int).Value = VarAdministrativeStatus
                    .Parameters.AddWithValue("@InsertTime", SqlDbType.Date).Value = VarInsertTime
                    .Parameters.AddWithValue("@UserID_Insert", SqlDbType.Int).Value = VarUserID
                End With
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        VarAdministrativeParentCode = Me.txtAdministrativeParentCode.Text
