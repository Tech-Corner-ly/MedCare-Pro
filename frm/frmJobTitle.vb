...
Public Class frmJobTitle
    ...
    Private MyVarDT_JobTitle As DataTable = New DataTable
    Private MyVarDV_JobTitle As DataView = New DataView



    Private VarSelAdjective As String
    Private VarJobTitleName As String
    Public VarJobTitleID As Integer
    Public VarJobTitleStatus As Integer = 1
    Private VarCount As String


    Private sQLDelete As String = "Update tbJobTitle Set JobTitleStatus=@JobTitleStatus,DeleteTime=@DeleteTime,UserID_Delete=@UserID_Delete Where JobTitleID=@JobTitleID"
    Private sQLUpdate As String = "Update tbJobTitle Set JobTitle=@JobTitle,Adjective=@Adjective,UpdateTime=@UpdateTime,UserID_Update=@UserID_Update Where JobTitleID=@JobTitleID"
    Private sQLInsert As String = "Insert Into tbJobTitle (JobTitle,JobTitleStatus,Adjective,InsertTime,UserID_Insert)values(@JobTitle,@JobTitleStatus,@Adjective,@InsertTime,@UserID_Insert)"
    Private sQLJobTitle As String = "SELECT JobTitleID,JobTitle,Adjective FROM tbJobTitle Where JobTitleStatus=1"
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        VarJobTitleID = DataGridView1.CurrentRow.Cells.Item(0).Value.ToString
        Me.txtJobTitle.Text = DataGridView1.CurrentRow.Cells.Item(1).Value
    ...
    Private Sub BGW_Load_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BGW_Load.DoWork
        Try
            If CheckConn() = False Then
                VarBGW_Status = False
            Else
                MyVarDT_JobTitle.Clear()
                Call XCLS.MyCodes_Fill_DataTable(sQLJobTitle, MyVarDT_JobTitle)
                VarBGW_Status = True
            End If
        Catch ex As Exception
            VarBGW_Status = False
    ...
    Private Sub BGW_Load_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BGW_Load.RunWorkerCompleted
        If VarBGW_Status = True Then
            ...
            Call XCLS.MyCodes_Fill_Dgv(Me.DataGridView1, lblCount, MyVarDT_JobTitle, MyVarDV_JobTitle)
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        VarJobTitleName = Me.txtJobTitle.Text
    ...
    Private Sub BGW_Save_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BGW_Save.DoWork
        Try
            ...
            With Cmd
                .Parameters.Clear()
                .Parameters.AddWithValue("@JobTitle", SqlDbType.VarChar).Value = VarJobTitleName
                .Parameters.AddWithValue("@Adjective", SqlDbType.VarChar).Value = VarSelAdjective
                .Parameters.AddWithValue("@JobTitleStatus", SqlDbType.Int).Value = VarJobTitleStatus
    ...
    Private Sub BGW_Edit_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BGW_Edit.DoWork
        Try
            ...
            If DialogResult.Yes Then
                VarBGW_Status = True
                Dim Cmd As New SqlCommand(sQLUpdate, sQlConnection)
                With Cmd
                    .Parameters.Clear()
                    .Parameters.AddWithValue("@JobTitle", SqlDbType.VarChar).Value = VarJobTitleName
                    .Parameters.AddWithValue("@Adjective", SqlDbType.VarChar).Value = VarSelAdjective
                    ...
                    .Parameters.AddWithValue("@JobTitleID", SqlDbType.Int).Value = VarJobTitleID
                End With
                If sQlConnection.State = 1 Then sQlConnection.Close()
                sQlConnection.Open()
                Cmd.ExecuteNonQuery()
    ...
    Private Sub BGW_Delete_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BGW_Delete.DoWork
        Try
            ...
            If DialogResult.Yes Then
                VarBGW_Status = True
                VarJobTitleStatus = 0
                Dim Cmd As New SqlCommand(sQLDelete, sQlConnection)
                With Cmd
                    .Parameters.Clear()
                    .Parameters.AddWithValue("@JobTitleStatus", SqlDbType.Int).Value = VarJobTitleStatus
