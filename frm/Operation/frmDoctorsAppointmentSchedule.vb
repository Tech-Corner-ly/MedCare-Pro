...
#Region "SQL"
    ...
    Private sQLItemsName As String = "SELECT [ItemID]
                                                  ,[ItemName]
                                              FROM [vItemsServices]"
    Private sQLItemsServices As String = "SELECT [AppoinScheID]
                                                  ,[ClinicName]
                                                  ,Concat([EmpFirstName],' ',[EmpSurName]) as EmpName
                                                  ,[Day]
                                                  ,[AppoinScheFromTime]
                                                  ,[AppoinScheToTime]
                                                  ,[AllowNumCases]
...
#End Region
#Region "Load"
    Private Sub frmDoctorsAppointmentSchedule_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call MYSP_Show()
...
#Region "Event"
    Private Sub btnAddAppointment_Click(sender As Object, e As EventArgs) Handles btnAddAppointment.Click
        frmAddDoctorsAppointmentSchedule.Show()
    End Sub
#End Region
End Class